  ...
  Widget build(BuildContext context) {
    return Column(mainAxisSize: MainAxisSize.min, children: <Widget>[
      Padding(
        ...
        child: DisplayText(context.watch<LocalizationManager>().homeTitleText),
      ),
      Padding(
      ...
      Padding(
        ...
        child: Text(
          context.watch<LocalizationManager>().homeEmptyText,
          style: TextStyle(
     ...
     Padding(
        padding: const EdgeInsets.only(bottom: 40.0),
        child: Text(
          context.watch<LocalizationManager>().homeEmptyCallText,
